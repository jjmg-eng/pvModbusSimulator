...
// our mask contains the following widget names
  ...
  "",
  "",
  "Seleciona o sinal a ser configurado",
  "",
  "",
  "",
  "",
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQTable(p,Table2,0,8,5);
  pvSetGeometry(p,Table2,6,123,1020,279);
  pvSetFont(p,Table2,"Ubuntu",11,0,0,0,0);

  pvQComboBox(p,AIselect,0,0,AtBottom);
  pvSetGeometry(p,AIselect,3,430,150,60);
  pvSetFont(p,AIselect,"Ubuntu",11,0,0,0,0);
  pvToolTip(p,AIselect,pvtr("Seleciona o sinal a ser configurado"));

  pvQwtKnob(p,AMP,0);
  pvSetGeometry(p,AMP,170,430,140,140);
  qwtKnobSetKnobWidth(p,AMP,90);
  qwtKnobSetBorderWidth(p,AMP,2);
  qwtKnobSetTotalAngle(p,AMP,270.000000);
  qwtKnobSetSymbol(p,AMP,KnobLine);
  pvSetFont(p,AMP,"Ubuntu",11,0,0,0,0);

  pvQwtKnob(p,T,0);
  pvSetGeometry(p,T,340,430,140,140);
  qwtKnobSetKnobWidth(p,T,90);
  qwtKnobSetBorderWidth(p,T,2);
  qwtKnobSetTotalAngle(p,T,270.000000);
  qwtKnobSetSymbol(p,T,KnobLine);
  pvSetFont(p,T,"Ubuntu",11,0,0,0,0);

  pvQwtKnob(p,FASE,0);
  pvSetGeometry(p,FASE,510,431,140,140);
  qwtKnobSetKnobWidth(p,FASE,90);
  qwtKnobSetBorderWidth(p,FASE,2);
  qwtKnobSetTotalAngle(p,FASE,270.000000);
  qwtKnobSetSymbol(p,FASE,KnobLine);
  pvSetFont(p,FASE,"Ubuntu",11,0,0,0,0);

  pvQwtKnob(p,OFFSET,0);
  pvSetGeometry(p,OFFSET,680,430,140,140);
  qwtKnobSetKnobWidth(p,OFFSET,90);
  qwtKnobSetBorderWidth(p,OFFSET,2);
  qwtKnobSetTotalAngle(p,OFFSET,270.000000);
  qwtKnobSetSymbol(p,OFFSET,KnobLine);
  pvSetFont(p,OFFSET,"Ubuntu",11,0,0,0,0);
